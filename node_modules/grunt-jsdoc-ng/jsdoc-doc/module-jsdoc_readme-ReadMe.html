...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ReadMe</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ReadMe</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-jsdoc_readme.html">jsdoc/readme</a>~</span>
        
        ReadMe
        </h2>
        
            <div class="class-description">Represents a README file.</div>
...
<dt>
        ...
        <h4 class="name" id="ReadMe"><span class="type-signature"></span>new ReadMe<span class="signature">(path)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The filepath to the README.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="readme.js.html">readme.js</a>, <a href="readme.js.html#line19">line 19</a>
    </li></ul></dd>
