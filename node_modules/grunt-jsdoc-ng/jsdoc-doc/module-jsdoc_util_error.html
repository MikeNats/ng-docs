...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: jsdoc/util/error</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: jsdoc/util/error</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Helper functions for handling errors.</div>
...
<dl class="details">
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>As of JSDoc 3.3.0. This module may be removed in a future release. Use the module
<a href="module-jsdoc_util_logger.html">module:jsdoc/util/logger</a> to log warnings and errors.</li><ul></dd>
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="util_error.js.html">util/error.js</a>, <a href="util_error.js.html#line2">line 2</a>
    </li></ul></dd>
...
<dt>
        ...
        <h4 class="name" id="exports.handle"><span class="type-signature">(static) </span>exports.handle<span class="signature">(e)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Error</span>
            ...
            <td class="description last">The exception to log.</td>
        </tr>
...
<dl class="details">
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>As of JSDoc 3.3.0. This module may be removed in a future release.</li><ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="util_error.js.html">util/error.js</a>, <a href="util_error.js.html#line25">line 25</a>
    </li></ul></dd>
