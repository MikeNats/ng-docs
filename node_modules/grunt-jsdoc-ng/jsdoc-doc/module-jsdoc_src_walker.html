...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: jsdoc/src/walker</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: jsdoc/src/walker</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Traversal utilities for ASTs that are compatible with the Mozilla Parser API. Adapted from
[Acorn](http://marijnhaverbeke.nl/acorn/).</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_walker.js.html">src/walker.js</a>, <a href="src_walker.js.html#line1">line 1</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="Walker"><span class="type-signature">(static) </span>Walker<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_walker.js.html">src/walker.js</a>, <a href="src_walker.js.html#line475">line 475</a>
    </li></ul></dd>
