...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: jsdoc/tag/dictionary/definitions</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: jsdoc/tag/dictionary/definitions</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Define tags that are known in JSDoc.</div>
...
<dl class="details">
    ...
    <dd class="tag-author">
        <ul>
            <li><a href="mailto:micmath@gmail.com">Michael Mathews</a></li>
        </ul>
    </dd>
    ...
    <dd class="tag-license"><ul class="dummy"><li>Apache License 2.0 - See file 'LICENSE.md' in this project.</li></ul></dd>
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="tag_dictionary_definitions.js.html">tag/dictionary/definitions.js</a>, <a href="tag_dictionary_definitions.js.html#line1">line 1</a>
    </li></ul></dd>
...
<dt>
        ...
        <h4 class="name" id="defineTags"><span class="type-signature">(static) </span>defineTags<span class="signature">(dictionary, tagDefinitions<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="module-jsdoc_tag_dictionary.html">module:jsdoc/tag/dictionary</a></span>
        ...
        <tr>
                ...
                <td class="name"><code>tagDefinitions</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">A dictionary whose values define the rules for a JSDoc tag.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="tag_dictionary_definitions.js.html">tag/dictionary/definitions.js</a>, <a href="tag_dictionary_definitions.js.html#line841">line 841</a>
    </li></ul></dd>
