<h3 id="{{element.name}}" class="literal">
    <span class="kind">{{element.kind}}</span>
    <span class="name">{{element.name}}</span
   ><span ng-if="element.params || (element.kind == 'function') || (element.kind == 'class')"
     ><span>(</span
   ...
   ></span
   ><span class="extra" ng-if="element.scope == 'static'">asdfasfddcstatic</span
...
<div class="details">
  ...
  <div ng-if="element.returns">
    <h4>Returns</h4>
    <ul class="returns">
      <li ng-repeat="return in element.returns">
        <span class="types" ng-if="return.type"
           ><span class="type" ng-repeat="type in return.type.names" ng-bind-html="type|type"></span
        ></span>
